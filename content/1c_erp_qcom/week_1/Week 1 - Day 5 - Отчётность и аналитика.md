...
![Отчётность: от 800 000 записей к трём ответам](file:///Users/muradnurmagomedov/.gemini/antigravity/brain/a1869424-d55c-48c7-ac39-d15137537d05/w1d5_reporting_funnel_blueprint_ru_1772294516073.png)
...
![Три этажа отчётности: от реального времени к аудиту](file:///Users/muradnurmagomedov/.gemini/antigravity/brain/a1869424-d55c-48c7-ac39-d15137537d05/w1d5_reporting_floors_blueprint_ru_1772294532150.png)
...
![Анатомия отчёта: от регистра к решению](file:///Users/muradnurmagomedov/.gemini/antigravity/brain/a1869424-d55c-48c7-ac39-d15137537d05/w1d5_report_anatomy_blueprint_ru_1772294548154.png)
...
```text
Style: Technical process diagram, Blueprint aesthetic, clean ink lines, white background, isometric 3D perspective, schema style, precision drawing, no people, professional engineering look, architectural layering, accent color: corporate blue (#0055BB). Landscape 2:1, 1200×600px.
Content: Два P&L-отчёта рядом для сравнения. Левый — «По правилу "пропорционально выручке"»: красный итог «-340 000 руб.», пометка «УБЫТОК → Решение: закрыть». Правый — «По уточнённой модели»: зелёный итог «+300 000 руб.», пометка «ПРИБЫЛЬ → 3-е место в сети». Между ними — стрелка с надписью «Разница: 640 000 руб.» и причина: «Неправильная база распределения расходов». Внизу — вывод: «Один отчёт — два решения. База распределения определяет ответ».
Заголовок: «Один даркстор, два отчёта, два противоположных решения»
```
...
> [!TIP] Тизер Дня 6
> Мы изучили теорию: виды учёта, архитектуру предприятия, учётную политику, регистры и отчётность. Завтра — практикум: спроектируем структуру компании Q-commerce с нуля в ERP 2.5. Организации, подразделения, направления, склады, учётная политика — весь «скелет», на который потом нанизываются операции. → [[Week 1 - Day 6 - Практикум по архитектуре|День 6]]

---

← [[Week 1 - Day 4 - Документооборот и регистры|День 4]] | [[README|Оглавление]] | [[Week 1 - Day 6 - Практикум по архитектуре|День 6]] →
