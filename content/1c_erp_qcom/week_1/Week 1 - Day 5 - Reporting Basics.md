...
> [!TIP] Тизер Дня 6
> Мы изучили теорию: виды учёта, архитектуру предприятия, учётную политику, регистры и отчётность. Завтра — практикум: спроектируем структуру компании Q-commerce с нуля в ERP 2.5. Организации, подразделения, направления, склады, учётная политика — весь «скелет», на который потом нанизываются операции. → [[Week 1 - Day 6 - Enterprise Design Workshop|День 6]]

---

← [[Week 1 - Day 4 - Posting Logic|День 4]] | [[README|Оглавление]] | [[Week 1 - Day 6 - Enterprise Design Workshop|День 6]] →
